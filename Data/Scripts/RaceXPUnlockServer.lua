...
function UnlockVehicles(player)
    ...
    if totalRaceXp >= 5000 and totalRaceXp <= 13000 then
    ...
    if totalRaceXp >= 15000 and totalRaceXp <= 31000 then
    ...
    if totalRaceXp >= 35000 and totalRaceXp <= 66000 then
    ...
    if totalRaceXp >= 74000 and totalRaceXp <= 138000 then
